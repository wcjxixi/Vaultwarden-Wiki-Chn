...
如果您[设置了电子邮件](../configuration/smtp-configuration.md)，Vaultwarden 将以英语发送邮件。由于服务器不知道用户的首选语言设置（完全在客户端完成），因此目前不太可能在同一服务器上为不同用户提供多种语言。
...
* 简体中文 by @vlian5：[https://github.com/vlian5/vaultwarden\_zh\_cn](https://github.com/vlian5/vaultwarden_zh_cn)
...
* 荷兰语（AI 生成）by @demeesterroel：[https://github.com/demeesterroel/vaultwarden-lang-nl](https://github.com/demeesterroel/vaultwarden-lang-nl)
