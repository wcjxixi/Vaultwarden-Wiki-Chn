...
> [NodeWarden](https://github.com/shuaiplus/nodewarden) 是另一个与 Vaultwarden 类似的 Bitwarden 兼容的服务端，它运行在 Cloudflare Workers 上。NodeWarden 比 Vaultwarden 更轻量。类似的还有 [Warden](https://github.com/qaz741wsd856/warden-worker)。
