...
* [配置](configuration/README.md)
  ...
  * [8.使用 OpenId Connect 启用 SSO 支持](configuration/enabling-sso-support-using-openid-connect.md)
  * [9.允许从内部服务获取图标](configuration/allow-icon-fetching-from-internal-services.md)
  * [10.其他配置](configuration/other-configuration.md)
...
* [开发](development/README.md)
  * [1.构建二进制](development/building-binary.md)
  * [2.构建您自己的 Docker 镜像](development/building-your-own-docker-image.md)
  * [3.Git hooks](development/git-hooks.md)
  * [4.与上游 API 实现的区别](development/differences-from-the-upstream-api-implementation.md)
* [替代部署](alternative-deployments/README.md)
  ...
  * [5.Kubernetes 部署](alternative-deployments/kubernetes-deployment.md)
  * [6.禁用管理令牌](alternative-deployments/disable-the-admin-token.md)
